...
for week in recaps.getWeekNums():
  ...
  for matchup in schedule.getWeek(week)['matchups']:
    ...
    if "a" == bowlerGames.getGamePrefix(bowlers[2], week, 1) and "a" == bowlerGames.getGamePrefix(bowlers[3], week, 1):
      game1Pts = 1
      game2Pts = 1
      totalPts = 1
    ...
    data = [
      [
        bowlers[0],
        bowlerGames.establishingFlag(bowlers[0], week) + str(bowlerGames.getGame(bowlers[0], week)['averageBefore']),
        bowlerGames.establishingFlag(bowlers[0], week) + str(bowlerGames.getGame(bowlers[0], week)['handicapBefore']),
        ...
        bowlers[2],
        bowlerGames.establishingFlag(bowlers[2], week) + str(bowlerGames.getGame(bowlers[2], week)['averageBefore']),
        bowlerGames.establishingFlag(bowlers[2], week) + str(bowlerGames.getGame(bowlers[2], week)['handicapBefore']),
      ...
      [
        bowlers[1],
        bowlerGames.establishingFlag(bowlers[1], week) + str(bowlerGames.getGame(bowlers[1], week)['averageBefore']),
        bowlerGames.establishingFlag(bowlers[1], week) + str(bowlerGames.getGame(bowlers[1], week)['handicapBefore']),
        ...
        bowlers[3],
        bowlerGames.establishingFlag(bowlers[3], week) + str(bowlerGames.getGame(bowlers[3], week)['averageBefore']),
        bowlerGames.establishingFlag(bowlers[3], week) + str(bowlerGames.getGame(bowlers[3], week)['handicapBefore']),
